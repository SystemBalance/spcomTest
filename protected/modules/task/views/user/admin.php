...
<h1><?=Yii::t('TaskModule.user','Manage Users');?></h1>

<?php echo CHtml::link(Yii::t('TaskModule.user','Advanced Search'),'#',array('class'=>'search-button')); ?>
